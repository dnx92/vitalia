...
const footerLinks = {
  patient: [
    ...
    { label: "Specialties", href: "/search" },
    { label: "Health Tracking", href: "/dashboard/health" },
    { label: "Patient Reviews", href: "/search" },
  ],
  doctors: [
    { label: "Join Vitalia", href: "/auth/register?role=professional" },
    { label: "Doctor Login", href: "/auth/login" },
    { label: "Provider Support", href: "/support" },
  ],
  company: [
