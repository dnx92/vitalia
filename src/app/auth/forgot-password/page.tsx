      ...
      <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center py-12 px-4 bg-gradient-to-br from-blue-50 via-white to-slate-50">
        <div className="w-full max-w-md text-center">
          ...
          <div className="space-y-4">
            <Button onClick={() => { setIsSent(false); setEmail(""); }} className="w-full">
              Try Another Email
            </Button>
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center py-12 px-4 bg-gradient-to-br from-blue-50 via-white to-slate-50">
      <div className="w-full max-w-md">
        <Link href="/auth/login" className="inline-flex items-center gap-2 text-slate-500 hover:text-slate-700 mb-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-slate-500 font-medium">Enter your email and we&apos;ll send you a reset link</p>
        </div>
