      ...
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2 mb-6">
            <div className="w-12 h-12 bg-gradient-to-br from-blue-600 to-teal-500 rounded-xl flex items-center justify-center shadow-lg shadow-blue-600/25">
          ...
          <p className="text-slate-500 mt-2">Join Vitalia and manage your health</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-slate-100 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button
              type="submit"
              className="w-full h-12 text-base bg-gradient-to-r from-blue-600 to-teal-500 hover:from-blue-700 hover:to-teal-600"
              isLoading={isLoading}
            >
              Create Account
            </Button>
        ...
        <p className="mt-6 text-center text-xs text-slate-400">
          By creating an account, you agree to Vitalia&apos;s{' '}
          <Link href="/terms" className="text-slate-500 hover:text-slate-600 underline">
            Terms of Service
          </Link>{' '}
          and{' '}
          <Link href="/privacy" className="text-slate-500 hover:text-slate-600 underline">
            Privacy Policy
          </Link>
        </p>
      </div>
